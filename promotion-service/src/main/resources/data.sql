...
INSERT INTO promotion (id, title, description, create_at, update_at, start_at, end_at, status, discount_type, discount_value, max_discount, promotion_type, code, total_quantity, remaining_quantity, min_order_value, usage_limit_per_user) VALUES
...
(6, 'Tri Ân Hạng Đồng',
    ...
    NOW(), NOW(),
    '2026-01-01 00:00:00', '2026-12-31 23:59:59',
    0, 0, 5, 20000, 'ProductPromotion', NULL, NULL, NULL, NULL, NULL),
