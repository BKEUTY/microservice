...
public class ProductService {
    ...
    private ProductDto toProductDto(Product product) {
        ...
        return ProductDto.builder()
                ...
                .image(product.getImages() != null ? product.getImages().stream().map(ProductImage::getImageUrl).toList() : List.of())
                .minPrice(minPrice)
    ...
    private ProductDetailDto toDetailDto(Product product, PromotionPriceDto promotionPrice, ProductVariant productVariant) {
        ...
        return ProductDetailDto.builder()
                ...
                .productImages(product.getImages() != null ? product.getImages().stream().map(ProductImage::getImageUrl).toList() : List.of())
                .productName(product.getName())
                .name(productVariant.getProductVariantName())
                .description(product.getDescription())
                .image(productVariant.getProductImageUrls() != null ? productVariant.getProductImageUrls().stream().map(ProductImage::getImageUrl).toList() : List.of())
                .originPrice(productVariant.getPrice())
    ...
    ProductVariantDto toDto(ProductVariant productVariant, PromotionPriceDto promotionPrice) {
        ...
        return ProductVariantDto.builder()
                ...
                .productImageUrl(productVariant.getProductImageUrls() != null ? productVariant.getProductImageUrls().stream().map(ProductImage::getImageUrl).toList() : List.of())
                .stockQuantity(productVariant.getStockQuantity())
                .sold(productVariant.getSold())
