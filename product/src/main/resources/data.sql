...
INSERT INTO product (id, name, description, image, status, product_brand) VALUES
(1, 'Sữa Rửa Mặt CeraVe Foaming Cleanser', 'Sữa rửa mặt tạo bọt làm sạch sâu cho da dầu.', NULL, 0, 1),
(2, 'Sữa Rửa Mặt Cetaphil Gentle Skin Cleanser', 'Công thức dịu nhẹ không gây kích ứng.', NULL, 0, 2),
(3, 'Sữa Rửa Mặt La Roche-Posay Effaclar', 'Gel rửa mặt cho da dầu nhạy cảm.', NULL, 0, 3),
(4, 'Sữa Rửa Mặt Cosrx Low pH Good Morning', 'Cân bằng độ pH tự nhiên cho da.', NULL, 0, 7),
(5, 'Sữa Rửa Mặt Innisfree Green Tea', 'Chiết xuất trà xanh giúp sạch sâu.', NULL, 0, 7),
(6, 'Kem Chống Nắng Anessa Perfect UV', 'Công nghệ Aqua Booster chống nước mạnh mẽ.', NULL, 0, 7),
(7, 'Kem Chống Nắng La Roche-Posay Anthelios', 'Khả năng chống nắng quang phổ rộng.', NULL, 0, 3),
(8, 'Kem Chống Nắng Skin1004 Madagascar', 'Chiết xuất rau má làm dịu da.', NULL, 0, 7),
(9, 'Kem Chống Nắng Cell Fusion C Laser', 'Dành cho da sau điều trị laser.', NULL, 0, 7),
(10, 'Kem Chống Nắng L''Oreal Invisible Fluid', 'Kết cấu mỏng nhẹ không để lại vệt trắng.', NULL, 0, 7),
(11, 'Nước Hoa Hồng Lancôme Tonique Confort', 'Dưỡng ẩm sâu cho da khô.', NULL, 0, 7),
(12, 'Toner Kiehl''s Calendula Herbal', 'Chiết xuất hoa cúc làm dịu da.', NULL, 0, 7),
(13, 'Toner Mamonde Rose Water', '90.97% tinh chất hoa hồng.', NULL, 0, 7),
(14, 'Nước Hoa Hồng Klairs Supple Preparation', 'Cấp ẩm tức thì cho da.', NULL, 0, 7),
(15, 'Toner Paula''s Choice Skin Balancing', 'Se khít lỗ chân lông.', NULL, 0, 7),
(16, 'Serum Estee Lauder Advanced Night Repair', 'Phục hồi da ban đêm thần thánh.', NULL, 0, 6),
(17, 'Serum The Ordinary Niacinamide 10% + Zinc 1', 'Giảm thâm mụn và thu nhỏ lỗ chân lông.', NULL, 0, 7),
(18, 'Serum Skin1004 Madagascar Centella', '100% chiết xuất rau má tinh khiết.', NULL, 0, 7),
(19, 'Serum Klairs Freshly Juiced Vitamin C', 'Làm sáng da và mờ thâm.', NULL, 0, 7),
(20, 'Serum Timeless Vitamin B5 + Hyaluronic Acid', 'Cấp ẩm và phục hồi da tổn thương.', NULL, 0, 7),
(21, 'Kem Dưỡng Neutrogena Hydro Boost Water Gel', 'Cấp ẩm chuyên sâu dạng gel.', NULL, 0, 7),
(22, 'Kem Dưỡng Kiehl''s Ultra Facial Cream', 'Dưỡng ẩm suốt 24 giờ.', NULL, 0, 7),
(23, 'Kem Dưỡng Phục Hồi La Roche-Posay Cicaplast B5', 'Hỗ trợ tái tạo màng bảo vệ da.', NULL, 0, 3),
(24, 'Kem Dưỡng Clinique Dramatically Different', 'Cung cấp độ ẩm tối ưu.', NULL, 0, 7),
(25, 'Kem Dưỡng Laneige Water Bank Blue HA', 'Công nghệ HA mới dưỡng ẩm sâu.', NULL, 0, 7),
(26, 'Phấn Nước Laneige Neo Cushion Matte', 'Che phủ cao và lâu trôi.', NULL, 0, 7),
(27, 'Kem Nền Estee Lauder Double Wear', 'Lớp nền hoàn hảo trứ danh.', NULL, 0, 6),
(28, 'Phấn Phủ Mac Studio Fix Powder Plus', 'Kết hợp nền và phấn 2 trong 1.', NULL, 0, 7),
(29, 'Cushion Hera Black Cushion', 'Đẳng cấp trang điểm Hàn Quốc.', NULL, 0, 7),
(30, 'Kem Nền Maybelline Fit Me', 'Kiềm dầu hiệu quả.', NULL, 0, 7),
(31, 'Son Thỏi 3CE Velvet Lip Tint', 'Màu sắc trẻ trung, chất son mịn.', NULL, 0, 4),
(32, 'Son Kem Romand Juicy Lasting Tint', 'Hiệu ứng căng bóng môi.', NULL, 0, 7),
(33, 'Son Dưỡng Dior Addict Lip Glow', 'Son dưỡng huyền thoại biến hóa màu sắc.', NULL, 0, 5),
(34, 'Son Thỏi MAC Matte Lipstick', 'Màu son chuẩn, lâu trôi.', NULL, 0, 7),
(35, 'Son Kem Black Rouge Air Fit Velvet Tint', 'Mềm lòng với bảng màu đa dạng.', NULL, 0, 7),
(36, 'Nước Hoa Dior Sauvage Eau De Parfum', 'Mạnh mẽ, nam tính.', NULL, 0, 5),
(37, 'Nước Hoa Chanel Coco Mademoiselle', 'Quyến rũ và sang trọng.', NULL, 0, 7),
(38, 'Bộ Quà Tặng Skincare L''Oreal Paris', 'Sự kết hợp hoàn hảo cho làn da.', NULL, 0, 7),
(39, 'Dụng Cụ Massage Nâng Cơ ReFa Carat', 'Công nghệ microcurrent tiên tiến.', NULL, 0, 7),
(40, 'Máy Rửa Mặt Foreo Luna 4', 'Làm sạch sâu gấp 35 lần.', NULL, 0, 7);
