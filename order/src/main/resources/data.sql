...
(1, 930000, 'COD', '2026-03-10', '123 Lý Thường Kiệt, Phường 14, Quận 10, HCM|10:1:1', 'user-1', 0, 'Nguyễn Văn A', 30000, '2026-03-12'),
(2, 1105000, 'VNPAY', '2026-03-11', '45 Hàng Bài, Phường Hàng Bài, Hoàn Kiếm, Hà Nội|2:3:2', 'user-2', 0, 'Trần Thị B', 25000, '2026-03-13'),
(3, 5600000, 'Banking', '2026-03-15', '789 Điện Biên Phủ, Phường 25, Bình Thạnh, HCM|10:1:1', 'user-3', 1, 'Lê Hoàng C', 50000, '2026-03-17'),
(4, 1230000, 'COD', '2026-03-16', '12 Lê Lợi, Phường Bến Nghé, Quận 1, HCM|1:1:1', 'user-4', 1, 'Phạm Tuấn D', 20000, '2026-03-18'),
(5, 465000, 'VNPAY', '2026-03-18', '77 CMT8, Phường 6, Quận 3, HCM|3:1:1', 'user-5', 3, 'Võ Minh E', 15000, '2026-03-20'),
(6, 880000, 'COD', '2026-03-20', '123 Lý Thường Kiệt, Phường 14, Quận 10, HCM|10:1:1', 'user-1', 3, 'Nguyễn Văn A', 0, '2026-03-22'),
(7, 3535000, 'Banking', '2026-03-22', '55 Trần Hưng Đạo, Phường 7, Quận 5, HCM|5:1:1', 'user-6', 3, 'Bùi Hữu F', 40000, '2026-03-24'),
(8, 3485000, 'COD', '2026-03-25', '88 Hàng Bê, Phường Hàng Bạc, Hoàn Kiếm, Hà Nội|1:3:2', 'user-7', 4, 'Dương Thị G', 35000, '2026-03-27'),
(9, 520000, 'VNPAY', '2026-04-01', '200 Nguyễn Huệ, Phường Bến Nghé, Quận 1, HCM|1:1:1', 'user-8', 4, 'Hoàng Văn H', 0, '2026-04-03'),
(10, 2595000, 'Banking', '2026-04-03', '66 Bạch Đằng, Phường Thượng Lý, Hồng Bàng, Hải Phòng|1:4:3', 'user-9', 1, 'Trịnh Thị I', 50000, '2026-04-05'),
(11, 450000, 'COD', '2026-04-05', '99 Lê Thánh Tông, Phường Hàng Bài, Hoàn Kiếm, Hà Nội|2:3:2', 'user-2', 0, 'Trần Thị B', 0, '2026-04-07'),
(12, 1920000, 'VNPAY', '2026-04-07', '111 Tôn Đức Thắng, Phường Bến Nghé, Quận 1, HCM|1:1:1', 'user-3', 1, 'Lê Hoàng C', 45000, '2026-04-09'),
(13, 1210000, 'COD', '2026-04-10', '44 Nguyễn Chí Thanh, Phường Kim Mã, Ba Đình, Hà Nội|3:3:2', 'user-10', 4, 'Vũ Thị J', 30000, '2026-04-12'),
(14, 2775000, 'Banking', '2026-04-12', '222 Trần Phú, Phường Hà Đông, Quận Hà Đông, Hà Nội|5:3:2', 'user-4', 4, 'Phạm Tuấn D', 35000, '2026-04-14'),
(15, 3710000, 'VNPAY', '2026-04-14', '333 Phạm Hùng, Phường Mỹ Đình, Quận Nam Từ Liêm, Hà Nội|7:3:2', 'user-5', 0, 'Võ Minh E', 55000, '2026-04-16'),
(16, 1215000, 'COD', '2026-04-16', '144 Ba Trieu, Phường Hàng Bài, Hoàn Kiếm, Hà Nội|2:3:2', 'user-6', 0, 'Đặng Văn K', 25000, '2026-04-18'),
(17, 1155000, 'Banking', '2026-04-18', '255 Tây Hồ, Phường Tây Hồ, Quận Tây Hồ, Hà Nội|6:3:2', 'user-7', 1, 'Hoàng Thị L', 30000, '2026-04-20'),
(18, 2325000, 'VNPAY', '2026-04-20', '366 Đinh Tiên Hoàng, Phường Hàng Bài, Hoàn Kiếm, Hà Nội|1:3:2', 'user-1', 1, 'Nguyễn Văn M', 35000, '2026-04-22'),
